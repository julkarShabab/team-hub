...
export default function GoalDetailModal({
  ...
  const handleMilestoneToggle = async (milestone) => {
    ...
    try {
      ...
      // Check all milestones after this update
